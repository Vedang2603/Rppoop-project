...
class Cust_Win:
    def __init__(self,root):
        ...
        txtAddress= ttk.Entry(labelframeleft,width=29,textvariable=self.var_cust_address,font=("arial",13,"bold"))
        ...
        if self.var_cust_mobile.get()=="" or self.var_cust_mother.get()=="":
            ...
            try:
                ...
                my_cursor.execute("insert into customer values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(self.var_ref.get(),
                                                                                                ...
                                                                                                self.var_cust_mobile.get(),self.var_cust_email.get(),   self.var_cust_nationality.get(),self.var_cust_id_proof.get(),self.  var_cust_id_number.get(),self.var_cust_address.get()))
